...
OscP5 oscP5;
NetAddress dest;
String output = "Jeg ser ingen sodavand";
...
void showMessage(int i) {
  ...
  //Sætter currentMessage til at være i
  currentMessage = i;
  println(i);
  //Tager i og ændre "output" til at skulle skrive hvilken sodavand
  //der bliver holdt op foran skærmen.
  //Ændre tilbage til start skærm, hvis ingen sodavand bliver vist.
  if (i == 1) {
    output = "Jeg ser ingen sodavand";
  }
  //Ændre til cola
  else if (i == 2)
  {
    output = "Jeg ser en Coca Cola";
  }
  //Ændre til Faxe Kondi
  else if (i == 3)
  {
    output = "Jeg ser en Faxe Kondi";
  }
  //Ændre til Pepsi
  else if (i == 4)
  {
    output = "Jeg ser en Mirinda";
  }
  //Ændre til Fanta
  else if (i == 5)
  {
    output = "Hvis du har drukket den Pepsi er jeg skuffet";
  }
}
